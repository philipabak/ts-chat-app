 ...
 * limitations under the License.
 */
ie("firebase","9.6.9","app");const zr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyAlHuK19kMdlfolvRNAxIvdTRzWwy-usCA",authDomain:"chat-application-7d185.firebaseapp.com",databaseURL:"https://chat-application-7d185-default-rtdb.europe-west1.firebasedatabase.app",projectId:"chat-application-7d185",storageBucket:"chat-application-7d185.appspot.com",messagingSenderId:"938153404182",appId:"1:938153404182:web:8a2b23a610405c49671237"}));class Vr{constructor(e,t,n,i,s){this.id=e,this.username=t,this.message=n,this.timestamp=i,this.userId=s}displayChat(){const e=document.querySelector("#chat-div"),t=document.querySelector("#user"),n=document.querySelector("#user-id"),i=document.createElement("div"),s=document.createElement("div"),r=document.createElement("h5"),o=document.createElement("h5"),a=document.createElement("p"),l=document.createElement("button"),h=document.createElement("div");r.innerText=this.username,o.innerText=this.timestamp,a.innerText=this.message,l.innerText="X",l.className="delete-btn",i.className="user-div",s.className="mess-div",h.className="message-container",h.id=this.id,i.append(r),i.append(o),s.append(a),this.username==t.innerText&&this.userId==n.innerText&&(s.append(l),l.addEventListener("click",(()=>{console.log(t.innerText);Ar(Rr(zr,"/messages/"+this.id))})),a.addEventListener("click",(e=>{e.preventDefault(),this.editMessage(a)}))),h.append(i),h.append(s),e.prepend(h),document.body.append(e)}clearChat(){document.querySelector(`#${this.id}`).remove()}editMessage(e){e.setAttribute("contenteditable",!0),e.className="mess-edit",e.focus();const t=document.querySelector(".mess-edit");e.addEventListener("keydown",(n=>{if(13===n.keyCode||"Enter"===n.code){n.preventDefault(),e.setAttribute("contenteditable",!1),this.message=t.innerText;const i=Rr(zr,"/messages/"+this.id),s={};s["/message"]=this.message,Or(i,s),e.classList.remove("mess-edit")}}))}}const $r=Rr(zr,"/messages"),Yr=document.querySelector("#header-data"),Gr=document.querySelector("#login-btn"),Kr=document.querySelector("#add-message-btn"),Qr=document.querySelector("#user-id"),Xr=document.querySelector("#user"),Jr=document.querySelector("#message-form"),Zr=document.querySelector("#username-form"),eo=document.querySelector("#logout-btn"),to=document.querySelector("#username"),no=document.querySelector("#password"),io=document.querySelector("#message");let so=[];const ro=()=>{Wr($r,(e=>{const t=e.val();console.log(t);for(const e of so)e.clearChat();so=[];for(const e in t)so.push(new Vr(e,t[e].username,t[e].message,t[e].timestamp,t[e].userId));console.log(so);for(const e of so)e.displayChat()}))};Gr.addEventListener("click",(e=>{e.preventDefault(),""==to.value?alert("Enter username!"):""==no.value?alert("Password required!"):(Xr.innerText=to.value,Qr.innerText=no.value,to.value="",no.value="",Jr.style.display="flex",Zr.style.display="none",eo.style.display="block",Yr.style.justifyContent="space-between",ro())})),eo.addEventListener("click",(e=>{e.preventDefault(),window.location.reload()})),Kr.addEventListener("click",(e=>{e.preventDefault();const t=Date.now(),n=new Date(t),i=e=>e<10?"0"+e:e,s=i(n.getDate())+"-"+i(n.getMonth()+1)+"-"+n.getFullYear()+", "+i(n.getHours())+":"+i(n.getMinutes());if(console.log(s),""==Xr.innerText)alert("Enter username!");else if(""==io.value)alert("Enter text to post!");else{const e={message:io.value,username:Xr.innerText,timestamp:s,userId:Qr.innerText};io.value="";const t={};t[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Mr(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}($r).key]=e,Or($r,t),(()=>{if(ro(),so.length>25){let e=so[0];console.log(e),Ar(Rr(zr,"/messages/"+e.id))}})()}}));
//# sourceMappingURL=index.95656bf2.js.map
